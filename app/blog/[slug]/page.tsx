...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    ...
    // ✅ FIXED: Added https://
    alternates: {
      canonical: `https://quizforge-web.vercel.app/blog/${slug}`,
    },
    openGraph: {
      title: post.title,
      description: post.description,
      ...
      images: post.image ? [{ url: post.image }] : [],
      // ✅ FIXED: Added https://
      url: `https://quizforge-web.vercel.app/blog/${slug}`,
    },
    twitter: {
      card: 'summary_large_image',
      title: post.title,
...
// Breadcrumb Schema - FIXED all URLs
const breadcrumbSchema = (title: string, slug: string) => ({
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  "itemListElement": [
    {
      ...
      "name": "Home",
      // ✅ FIXED: Added https://
      "item": "https://quizforge-web.vercel.app"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Blog",
      // ✅ FIXED: Added https://
      "item": "https://quizforge-web.vercel.app/blog"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": title,
      // ✅ FIXED: Added https://
      "item": `https://quizforge-web.vercel.app/blog/${slug}`
    }
  ]
});
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // ✅ FIXED: BlogPosting Schema with correct URLs
  const blogSchema = {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "headline": post.title,
    ...
    "publisher": { 
      ...
      "logo": { 
        "@type": "ImageObject", 
        // ✅ FIXED: Added https://
        "url": "https://quizforge-web.vercel.app/logo.png" 
      } 
    },
    "mainEntityOfPage": { 
      "@type": "WebPage", 
      // ✅ FIXED: Added https://
      "@id": `https://quizforge-web.vercel.app/blog/${slug}` 
    },
    ...(post.image && { "image": post.image }),
  };
            ...
            <div className="flex-1 min-w-0 max-w-4xl">
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-white/10">
                  ...
                  {/* ✅ FIXED: ShareButtons URL now matches actual domain */}
                  <ShareButtons 
                    title={post.title} 
                    url={`https://quizforge-web.vercel.app/blog/${slug}`} 
                  />
